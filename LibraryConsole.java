...
public class LibraryConsole {
    ...
    public static void main(String[] args) {
        ...
        // Preload some books
        books.add(new Book( "Java Basics",true,1, "J. Smith", "111"));
        books.add(new Book( "OOP with Java",true,2, "A. Brown", "222"));
    ...
    private static void addMember() {
        try {
            ...
            Member member = type.equalsIgnoreCase("Student") ?
                    new StudentMember(id, name, email,0) :
                    new StaffMember(id, name, email,0);
    ...
    private static void addBook() {
        ...
        boolean available = true; // new books are available by default
        
        if (id.isEmpty() || title.isEmpty() || author.isEmpty() || isbn.isEmpty()) {
            System.out.println("All fields required.");
            return;
        }
        books.add(new Book( title, available, itemId ,author, isbn));
